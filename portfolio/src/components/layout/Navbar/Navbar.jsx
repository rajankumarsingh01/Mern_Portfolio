...
const buildSocials = (profile) => [
  { label: "GitHub", href: profile?.githubURL || SITE.github },
  { label: "LinkedIn", href: profile?.linkedInURL || SITE.linkedin },
  ...(profile?.resume?.url ? [{ label: "Resume", href: profile.resume.url }] : []),
];
          ...
          <div className="ovl-inner">
            ...
            >
              <div className="ovl-footer-left">
                ...
                <a href={`mailto:${SITE.email}`} className="ovl-email">
                  {SITE.email}
                </a>
              </div>
