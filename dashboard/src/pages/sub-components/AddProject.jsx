...
const AddProject = () => {
  ...
  useEffect(() => {
    ...
    if (message) {
      ...
      setProblemStatement(""); setSolution(""); setHighlights(""); setDemoVideoUrl("");
    }
        ...
        <form onSubmit={handleAddNewProject} className="space-y-8">
          <div className="rounded-3xl border border-zinc-800 bg-zinc-900 p-6 md:p-8 shadow-2xl">
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="md:col-span-2 rounded-2xl border border-dashed border-zinc-700 p-5">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="md:col-span-2">
                    ...
                    <Textarea
                      placeholder="What real problem does this project solve? Who faces it?"
                  ...
                  <div className="md:col-span-2">
                    ...
                    <Textarea
                      placeholder="How did you solve it? What was your approach, key decisions?"
                      value={solution}
                  ...
                  <div className="md:col-span-2">
                    ...
                    <Textarea
                      placeholder={"JWT auth with refresh tokens\nRazorpay payment integration\n50k+ records handled with pagination"}
                      value={highlights}
                      onChange={(e) => setHighlights(e.target.value)}
                      className="min-h-[110px] border-zinc-700 bg-zinc-800 text-white placeholder:text-zinc-500 focus:border-cyan-500"
                    />
                  </div>
                  <div className="md:col-span-2">
                    <label className="mb-2 block text-sm font-medium text-zinc-300">
                    ...
                    <input
                      type="text"
                      placeholder="YouTube link (e.g. https://youtu.be/xxxx)"
                      value={demoVideoUrl}
